...
import ai_logic_使用tensorflow框架.ai as ai
...
def gameStart():
    ...
    car = my_item.Car(50, 220, speed=400)
    ...
    while running:
        ...
        if car.alive:
            ...
            res = ai.sess.run(ai.prediction, feed_dict={ai.xs: [[car.dis_wall, car.ldis_wall, car.lldis_wall,
                                                                 car.rdis_wall, car.rrdis_wall, car.v, car.r]]})
            speed = res[0][0]
            direction = res[0][1]
